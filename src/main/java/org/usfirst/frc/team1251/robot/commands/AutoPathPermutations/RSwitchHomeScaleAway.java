...
public class RSwitchHomeScaleAway extends CommandGroup {
    public RSwitchHomeScaleAway (Arm arm, ArmPosition armPosition, Claw claw, Collector collector, DriveFeedback driveFeedback, DriveTrain driveTrain, DriveTrainShifter shifter, Elevator elevator, ElevatorPosition elevatorPosition){
