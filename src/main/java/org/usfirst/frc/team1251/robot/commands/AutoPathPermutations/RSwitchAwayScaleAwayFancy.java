...
public class RSwitchAwayScaleAwayFancy extends CommandGroup {
    public RSwitchAwayScaleAwayFancy(Elevator elevator, ElevatorPosition elevatorPosition, Arm arm, ArmPosition armPosition, Claw claw, Collector collector, DriveFeedback driveFeedback, DriveTrain driveTrain, DriveTrainShifter driveTrainShifter){
