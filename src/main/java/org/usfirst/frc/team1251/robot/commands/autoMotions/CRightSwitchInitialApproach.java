...
public class CRightSwitchInitialApproach extends CommandGroup {


    public CRightSwitchInitialApproach(DriveFeedback driveFeedback, DriveTrain driveTrain,
    ...
    private class ToSwitch extends FollowPath {
        private ToSwitch(DriveTrain driveTrain, DriveFeedback driveFeedback) {
            super("CRightSwitch_Cube1_StartToSwitch", driveTrain, driveFeedback);
        }
    }
}
