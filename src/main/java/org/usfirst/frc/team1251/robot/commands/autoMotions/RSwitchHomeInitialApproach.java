...
public class RSwitchHomeInitialApproach extends CommandGroup {


    public RSwitchHomeInitialApproach(DriveFeedback driveFeedback, DriveTrain driveTrain,
    ...
    private class ToSwitch extends FollowPath {
        private ToSwitch(DriveTrain driveTrain, DriveFeedback driveFeedback) {
            super("RSwitchHome_Cube1_StartToSwitch", driveTrain, driveFeedback);
        }
    }
}
