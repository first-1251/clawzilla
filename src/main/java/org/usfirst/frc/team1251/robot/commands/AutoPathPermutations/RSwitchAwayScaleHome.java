...
public class RSwitchAwayScaleHome extends CommandGroup {
    public RSwitchAwayScaleHome (Arm arm, ArmPosition armPosition, Claw claw, Collector collector, DriveFeedback driveFeedback, DriveTrain driveTrain, DriveTrainShifter shifter, Elevator elevator, ElevatorPosition elevatorPosition){
