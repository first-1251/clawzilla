...
public class RSwitchAwayScaleHome extends CommandGroup {
    public RSwitchAwayScaleHome (Arm arm, ArmPosition armPosition,Claw claw, Collector collector, DriveTrain driveTrain, DriveFeedback driveFeedback, DriveTrainShifter shifter, Elevator elevator, ElevatorPosition elevatorPosition) {
        ...
        addSequential(new AutoForwards(driveFeedback, driveTrain, shifter, 175.00));
