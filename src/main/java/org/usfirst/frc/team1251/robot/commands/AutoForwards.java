...
public class AutoForwards extends Command {
    ...
    private final double ALLOWABLE_ERROR = 200.0; // in encoder ticks, 1/10 of an encoder turn, 1/30 of a wheel turn
    private final double WHEEL_DIAMETER = 4.25;
    private final double INCHES_TO_WHEEL_TURNS = 1.0 / (WHEEL_DIAMETER * Math.PI);
    private final double WHEELS_TURNS_TO_ENCODER_TICKS = 500 * GEAR_RATIO;  // 1 wheel turn
...
static int counter = 0;
    ...
    protected void initialize() {
        ...
        leftDistance = totalDistance + driveTrain.getLeftDistance();
        rightDistance = totalDistance + driveTrain.getRightDistance();
