...
public class RSwitchAwayScaleAway extends CommandGroup {
    public RSwitchAwayScaleAway(Arm arm, ArmPosition armPosition, Claw claw, Collector collector, DriveFeedback driveFeedback, DriveTrain driveTrain, DriveTrainShifter driveTrainShifter) {
        ...
        addSequential(new AutoForwards(driveFeedback, driveTrain, driveTrainShifter, 175));
